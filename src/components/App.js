  ...
  return ( 
    <div className="flex justify-center min-h-screen items-center  bg-gray-50">
     ...
     <div className="bg-teal-300 flex justify-center items-center shadow-[0_35px_60px_-15px_rgba(0,0,0,85)]">
        <div className="bg-teal-300 ml-20 w-[500px] h-[600px] flex justify-center items-center ">
         ...
         <div className="bg-slate-50 w-[950px] h-[1000px] flex  items-center">
      <div className="bg-slate-100 w-[660px] h-[600px] flex items-center justify-center flex-col  p-8">
